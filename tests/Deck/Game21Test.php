...
class Game21Test extends \PHPUnit\Framework\TestCase {
    ...
    public function testTotalScoreBlack() {
        $deck = new Game21();
        $decide_winner = $deck->totalScoreBlack(21, 20);
    ...
    public function testTotalScoreBlack2() {
        $rules = new Game21();
        $decide_winner = $rules->totalScoreBlack(20, 21);
    ...
    public function testTotalScoreBlack3() {
        $rules = new Game21();
        $decide_winner = $rules->totalScoreBlack(20, 22);
    ...
    public function testTotalScoreBlack4() {
        $rules = new Game21();
        $decide_winner = $rules->totalScoreBlack(22, 20);
    ...
    public function testTotalScoreBlack5() {
        $rules = new Game21();
        $decide_winner = $rules->totalScoreBlack(19, 20);
    ...
    public function testTotalScoreBlack6() {
        $rules = new Game21();
        $decide_winner = $rules->totalScoreBlack(19, 19);
    ...
    public function testTotalScoreBlack7() {
        $rules = new Game21();
        $decide_winner = $rules->totalScoreBlack(19, 18);
